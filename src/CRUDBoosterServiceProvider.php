<?php namespace muhammadfahrul\crudbooster;

use muhammadfahrul\crudbooster\commands\CrudboosterVersionCommand;
use muhammadfahrul\crudbooster\commands\Mailqueues;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\ServiceProvider;
use muhammadfahrul\crudbooster\commands\CrudboosterInstallationCommand;
use muhammadfahrul\crudbooster\commands\CrudboosterUpdateCommand;
...
class CRUDBoosterServiceProvider extends ServiceProvider
{
    ...
    {        
        ...
        if($this->app->runningInConsole()) {
            ...
            $this->publishes([__DIR__.'/userfiles/middlewares/CBAuthAPI.php' => app_path('Http/Middleware/CBAuthAPI.php')],'CBAuthAPI');
    ...
    {                                   
        ...
        $loader->alias('CRUDBooster', 'muhammadfahrul\crudbooster\helpers\CRUDBooster');
        $loader->alias('CB', 'muhammadfahrul\crudbooster\helpers\CB');
    }
