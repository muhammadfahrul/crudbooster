<?php namespace muhammadfahrul\crudbooster\controllers;
	...
	class AdminMerchantController extends \muhammadfahrul\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "merchant_id";
			$this->limit = "20";
			...
			$this->col[] = ["label"=>"Status","name"=>"status",'callback_php' => '($row->status)?"<span class=\"label label-success\">Active</span>":"<span class=\"label label-default\">Not Active</span>"'];
			$this->col[] = ["label"=>"Created At","name"=>"created_at","filter"=>"date"];
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'radio','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'0|Not Active;1|Active'];
