...
<div class="login-box">
    <div class="row">
        <div class="col-xs-6 login-box-form" style="padding-right: 0px; padding-left: 0px; border: 1px solid #c8ced3;">
        ...
        <div class="col-xs-6 login-box-image" style="padding-right: 0px; padding-left: 0px; border: 1px solid #c8ced3;">
            <div class="login-box-body">
                <div class="thumbnail" style="height: 100%; margin-bottom: 0px;">
                    <img class="img-fluid" style="width: 100%; height: 100%;" src='{{ CRUDBooster::getSetting("logo")?asset(CRUDBooster::getSetting('logo')):asset('vendor/crudbooster/assets/logo_crudbooster.png') }}'>
                </div>
            </div><!-- /.login-box-body -->
        </div>
    </div>
