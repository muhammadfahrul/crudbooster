...
<header class="main-header">
    ...
    <a href="{{url(config('crudbooster.ADMIN_PATH'))}}" title='{{Session::get('appname')}}' class="logo"><img src="{{CRUDBooster::getSetting("logo")?asset(CRUDBooster::getSetting('logo')):asset('vendor/crudbooster/assets/logo_crudbooster.png')}}"></a>
    @else
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-{{ cbLang('right') }}">
                                ...
                                <a href="javascript:void(0)" onclick="swal({
                                        ...
                                        });" title="{{cbLang('button_logout')}}" class="btn btn-default btn-flat"><i class='fa fa-power-off'></i></a>
                            </div>
                        </li>
                    </ul>
                </li>
