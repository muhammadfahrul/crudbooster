            ...
            @push('bottom')
                <script>
                    ...
                    function load_response() {
                        ...
                        $('#table-response tbody').append("<tr><td>#</td><td>response</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
                        $('#table-response tbody').append("<tr><td>1</td><td> - code</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
                        $('#table-response tbody').append("<tr><td>2</td><td> - message</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
                        $('#table-response tbody').append("<tr><td>3</td><td> - latency</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
                        $('#table-response tbody').append("<tr><td>4</td><td> - host</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
