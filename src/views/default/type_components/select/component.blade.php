        ...
        <select class='form-control' id="{{$name}}" data-value='{{$value}}' {{$required}} {!!$placeholder!!} {{$readonly}} {{$disabled}} name="{{$name}}">
            ...
            if (! $form['parent_select']) {
                ...
                if (@$form['datatable']):
                    ...
                    $primaryKey = CRUDBooster::findPrimaryKey($table1);
                    $selects_data = DB::table($table1)->select($table1.".".$primaryKey);
                    ...
                    if ($table2 && $column2) {
                        ...
                        $selects_data->join($table2, $table2.'.'.$primaryKey, '=', $table1.'.'.$column1);
                    ...
                    if ($table3 && $column3) {
                        ...
                        $selects_data->join($table3, $table3.'.'.$primaryKey, '=', $table2.'.'.$column2);
