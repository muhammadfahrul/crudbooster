...
?>
@if(file_exists(base_path('/vendor/muhammadfahrul/crudbooster/src/views/default/type_components/'.$type.'/asset.blade.php')))
...
<div class='table-responsive'>
    <table id='table-detail' class='table table-striped'>
        ...
        if (isset($form['default_row_key'])) {
            @$value = $row->{$form['default_row_key']};
        }
        ...
        $file_location = base_path('vendor/muhammadfahrul/crudbooster/src/views/default/type_components/'.$type.'/component_detail.blade.php');
