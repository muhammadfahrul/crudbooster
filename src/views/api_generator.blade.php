    ...
    <div class='box'>
        ...
        <div class='box-body'>
            @push('bottom')
                <script>
                    ...
                    function load_response() {
                        ...
                        $('#table-response tbody').append("<tr><td>#</td><td>code</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
                        $('#table-response tbody').append("<tr><td>#</td><td>status</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
                        $('#table-response tbody').append("<tr><td>#</td><td>message</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
                        $('#table-response tbody').append("<tr><td>#</td><td>ip</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
                        $('#table-response tbody').append("<tr><td>#</td><td>latency</td><td></td><td>-</td><td><select class='form-control' disabled><option>YES</option></select></td><td>-</td></tr>");
                        ...
                        if (tipe_action == 'save_add') {
                            $('#table-response tbody').append("<tr class='info' style='font-weight'><td>#</td><td>data</td><td>&nbsp;</td><td>-</td><td>-</td><td>-</td></tr>");
                        }

                        if (tipe_action == 'save_edit') {
                            $('#table-response tbody').append("<tr class='info' style='font-weight'><td>#</td><td>data</td><td>&nbsp;</td><td>-</td><td>-</td><td>-</td></tr>");
                        }

                        if (tipe_action == 'delete') {
                            $('#table-response tbody').append("<tr class='info' style='font-weight'><td>#</td><td>data</td><td>&nbsp;</td><td>-</td><td>-</td><td>-</td></tr>");
                        }
            ...
            <form method='post' action='{{ route("ApiCustomControllerPostSaveApiCustom")}}'>
                ...
                <div class='form-group'>
                    <input type='submit' class='btn btn-primary' value='SAVE & GENERATE API'/>
                </div>
