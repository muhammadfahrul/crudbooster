<?php namespace muhammadfahrul\crudbooster\commands;
...
class CrudboosterUpdateCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $configLFMModified = str_replace("['web','auth']", "['web','\muhammadfahrul\crudbooster\middlewares\CBBackend']", $configLFM);
