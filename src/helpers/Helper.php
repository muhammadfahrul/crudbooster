...
if(!function_exists('db')) {
    ...
    function db(string $table) {
        $modulsConnection = DB::table('cms_moduls')->where('table_name', $table)->first()->connection;
        if ($modulsConnection) {
            return \Illuminate\Support\Facades\DB::connection($modulsConnection)->table($table);
        }else {
...
if(!function_exists('get_setting')) {
    ...
    function get_setting($key, $default = null) {
        $setting = \muhammadfahrul\crudbooster\helpers\CB::getSetting($key);
